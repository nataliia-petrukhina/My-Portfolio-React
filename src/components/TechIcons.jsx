...
import "../css/TechIcons.css"; // Для стилей (ниже пример)
...
const TechIcons = () => {
  return (
    <div className="tech-icons">
      ...
      <i className="devicon-css3-plain-wordmark colored" title="Next.js"></i>
      ...
      <i class="devicon-tailwindcss-original colored" title="Tailwind"></i>
    </div>
  );
};
